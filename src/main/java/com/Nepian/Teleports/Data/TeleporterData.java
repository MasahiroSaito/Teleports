...
public class TeleporterData {
	...
	public TeleporterData(OfflinePlayer player, Block block, String name) {
		this.owner = player;
		this.blockLocation = block.getLocation();
		this.name = name;
		this.type = TeleporterType.getType(block);
		this.teleportLocation = initTeleportLocation(this.blockLocation);
		this.member = New.newList();
		this.isPrivate = false;
	}
	...
	public String toString() {
		...
		sb.append(type.toString()).append(":").append("\n");
		sb.append(" # ").append("Name: ").append(name).append("\n");
		sb.append(" # ").append("Owner: ").append(owner.getName()).append("\n");
		sb.append(" # ").append("Blcok: ").append(LocationStringable.toString(blockLocation)).append("\n");
		sb.append(" # ").append("Teleport: ").append(LocationStringable.toString(teleportLocation)).append("\n");
		sb.append(" # ").append("Member: ").append(memberToString(member)).append("\n");
		sb.append(" # ").append("Private: ").append(isPrivate);
		return sb.toString();
	}
